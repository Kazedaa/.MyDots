...
if os.path.exists(f"{home}/Pictures/Thumbnails/{file}"):
    ...
    os.system(f"neofetch --kitty '{home}/Pictures/Thumbnails/{file}' --colors '{colors[4]}' '231' '0' '{colors[5]}' '0' '{colors[3]}'") # --colors ({data[12]} {data[12]} {data[12]} {data[12]} {data[12]} {data[12]})'")
else:
