...
print(os.path.exists(f"{home}/Pictures/Thumbnails/file"))
if os.path.exists(f"{home}/Pictures/Thumbnails/file"):
    os.system(f'wallust run "wallpaper_cache" --palette "dark16" --quite')
    os.system(f"neofetch --kitty '{home}/Pictures/Thumbnails/{file}' --colors '{colors[5]}' '{colors[5]}' '{colors[5]}' '{colors[5]}' '{colors[5]}' '{colors[5]}'") # --colors ({data[12]} {data[12]} {data[12]} {data[12]} {data[12]} {data[12]})'")
else:
   os.system(f"neofetch --kitty '{default}' --colors '21' '15' '0' '33' '0' '79'")
