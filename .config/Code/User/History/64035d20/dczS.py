...
if os.path.exists(f"{home}/Pictures/Thumbnails/{file}"):
    ...
    os.system(f"neofetch --kitty '{home}/Pictures/Thumbnails/{file}' --colors '{colors[4]}' '{colors[5]}' '0' '{colors[12]}' '0' '{colors[4]}'") # --colors ({data[12]} {data[12]} {data[12]} {data[12]} {data[12]} {data[12]})'")
else:
